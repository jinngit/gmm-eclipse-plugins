...
public interface GMMRunconfigConstant {
	...
	public final static String PASSWORD = GENMYMODEL_RUNCONF_PREFIX + "CREDENTIAL_PASSWORD";
	public final static String GENMYMODEL_RUNCONF_TYPE = GENMYMODEL_RUNCONF_PREFIX + "type";
	public final static String GENMYMODEL_RUNCONF_GROUPID = GENMYMODEL_RUNCONF_PREFIX + "group";
}
